...
if __name__ == '__main__':
	...
	base_path = '/workspace/Shared/Users/malindgren/predictfest/CFSv2_GRIB'
	output_path = '/workspace/Shared/Users/malindgren/predictfest/CFSv2_NetCDF'

	for group in groups:
		print( 'preparing: {}...'.format( group ) )
		bp = os.path.join( base_path, group )
		op = os.path.join( output_path, group )
