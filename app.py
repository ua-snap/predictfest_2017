...
# forecasts
forecast_lookup = {year:xr.open_dataset('./data/akcan_nevents_forecast_cfsv2_7_62_{}.nc'.format(year))['derived'] for year in range(2011, 2018)}

# clims
clim_counts = xr.open_dataset( './data/akcan_nevents_climatology_cfsv2_2_54.nc' )['derived']
...
def update_graph( clickdata, year ):
    ...
    if clickdata is not None:
        ...
        return {'data':[ go.Scatter( x=months, 
                        y=dat, 
                        name='28-year Avg', 
